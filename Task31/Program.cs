...
//         if(arr[i] > 0)
//         {
//             sumPositive += arr[i];                Альтернативное решение
//         }
//         else
//         {
//             sumNegative += arr[i];
...
// int[] sumPositiveNegativeElem = SumPositivNegativeElem(array);
// Console.WriteLine($"Сумма положительных элементов = {sumPositiveNegativeElem[0]}");  Альтернативное решение
